    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-4 col-lg-3 col-xl-3">
          ...
          <ul class="list-unstyled">
            <li>
              <i class="fa fa-home mr-2" /> My company
            </li>
            <li>
              <i class="fa fa-envelope mr-2" /> email@example.com
            </li>
            <li>
              <i class="fa fa-phone mr-2" /> + 33 12 14 15 16
            </li>
            <li>
              <i class="fa fa-print mr-2" /> + 33 12 14 15 16
            </li>
          </ul>
        </div>
